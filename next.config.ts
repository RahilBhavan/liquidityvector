    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' blob: data:; font-src 'self'; connect-src 'self' http://localhost:8000 https://api.rahilbhavan.com https://*.alchemy.com https://*.infura.io wss://*.walletconnect.org https://*.walletconnect.org;",
          },
        ],
      },
    ];
